...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private static final float SCALE_STEP = 0.1f; // view叠加缩放的步长
    //缩放层叠效果

    private int MAX_VISIBLE = 2; // 值建议最小为4
    ...
    private boolean isBanLayout = false;
...
//    public void setIsBanLayout(boolean b) {
//        isBanLayout = b;
//    }
    ...
    private void setTopView() {
        if (getChildCount() > 0) {
            ...
            if (mActiveCard != null && mFlingListener != null) {
                ...
                flingCardListener = new FlingCardListener(mContext,mActiveCard, mAdapter.getItem(0),
